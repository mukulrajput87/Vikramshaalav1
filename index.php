					...
					<div class="row">
						<div class="slider-content-area">
							<div class="slide-text">
								...
								<h2>With Vikramshaala Solutions responsive landing page template, <br>you can promote your all web design & development services. </h2>
								<div class="slider-content-btn">
									<a class="button btn btn-light btn-radius btn-brd" href="about-us">Read More</a>
									<a class="button btn btn-light btn-radius btn-brd" href="contact-us">Contact</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="slider-content-area">
							<div class="slide-text">
								...
								<h2>With Vikramshaala Solutions responsive landing page template, <br>you can promote your all web design & development services. </h2>
								<div class="slider-content-btn">
									<a class="button btn btn-light btn-radius btn-brd" href="index">Read More</a>
									<a class="button btn btn-light btn-radius btn-brd" href="Contact-us">Contact</a>
								</div>
							</div>
						</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">
                        <h4>About Us</h4>
                        <h2>Welcome to Vikramshaala Solutions</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="message-box">
                        <h4>Who We are</h4>
                        <h2>We Are Vikramshaala Solutions</h2>
                        <p class="lead">Quisque eget nisl id nulla sagittis auctor quis id. Aliquam quis vehicula enim, non aliquam risus. Sed a tellus quis mi rhoncus dignissim.</p>
    ...
    <div id="services" class="parallax section lb">
        <div class="container">
            ...
            <div class="text-center">
                <a data-scroll href="Service" class="btn btn-light btn-radius btn-brd">View Our Service</a>
            </div>
        </div><!-- end container -->
    </div><!-- end section -->
            ...
            <div class="row text-center">
                <div class="col-md-6">
                    <div class="customwidget text-left">
                        ...
                        <a href="portfolio" data-scroll class="btn btn-light btn-radius btn-brd">Learn More</a>
                    </div>
                </div><!-- end col -->
				<div class="col-md-6">
